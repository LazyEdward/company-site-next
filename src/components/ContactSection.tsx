...
const ContactSection = ({
	...
	<>
		<section className="w-full flex justify-center items-center h-[565px] lg:h-[992px] lg:px-[10vw] overflow-x-auto">
			<section className="relative w-full h-full max-w-[1536px] flex items-center overflow-hidden">
				<div className="relative w-[1000px] h-full flex max-w-full lg:max-w-[1000px]">
					<Image width={1000} height={992} className="object-cover max-w-full lg:max-w-[1000px] rounded-br-[100px] " src={`/${imgSrc}`} alt="Contact Image"/>
				</div>
